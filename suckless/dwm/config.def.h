...
static const int smartgaps = 1;  		/* 1 = remove all gaps when only one window visible */
...
static const char col_gray2[]       = "#252530";
static const char col_gray3[]       = "#cdcdcd";
static const char col_gray4[]       = "#cdcdcd";
static const char col_cyan[]        = "#252530";
