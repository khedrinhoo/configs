...
/*
static const char col_background[]  = "#161616";
static const char col_foreground[]  = "#ffffff";
static const char col_focus[]       = "#33b1ff";
static const char col_unfocus[]     = "#262626";

static const char *colors[][3]      = {
	[SchemeNorm] = { col_foreground, col_background, col_unfocus },
	[SchemeSel]  = { col_foreground, col_focus, col_focus  },
};
...
// static const char *dmenucmd[] = { "dmenu_run", "-m", dmenumon, "-fn", dmenufont, "-nb", col_background, "-nf", col_foreground, "-sb", col_focus, "-sf", col_foreground, NULL };
